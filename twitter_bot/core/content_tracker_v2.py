...
class ContentTracker:
    ...
    def __init__(self, tracker_file: str = "content_tracker_v2.json"):
        ...
        self.similarity_threshold = 0.4  # 40% similarity threshold (adjusted for better detection)
    ...
    def mark_tweet_replied(self, tweet_id: str):
        """Mark tweet as replied to"""
        self.data['replied_tweets'][tweet_id] = datetime.now().isoformat()
        self._save_tracker_data()
